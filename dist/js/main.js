...
/*MODULE EXPORT*/
module.exports = {
    generateGlobalSettings: function generateGlobalSettings(gsData) {
        console.log('hello world, I am from globalSettings.js');
    }
};
